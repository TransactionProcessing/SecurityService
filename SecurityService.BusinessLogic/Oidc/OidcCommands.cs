...
public static class OidcCommands
{
    ...
    public sealed record ConsentGetQuery(HttpContext HttpContext, string TransactionId) : IRequest<Result<ConsentGetQueryResult>>;
    public sealed record ConsentPostCommand(HttpContext HttpContext, string TransactionId, string Button, IReadOnlyCollection<string> SelectedScopes) : IRequest<Result<ConsentPostCommandResult>>;
