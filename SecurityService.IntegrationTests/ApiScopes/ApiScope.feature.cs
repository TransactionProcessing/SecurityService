...
namespace SecurityService.IntegrationTests.ApiScopes
{
    ...
    public partial class ApiScopeFeature : object, Xunit.IClassFixture<ApiScopeFeature.FixtureData>, Xunit.IAsyncLifetime
    {
...
#line hidden
        ...
        public ApiScopeFeature(ApiScopeFeature.FixtureData fixtureData, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
...
#line hidden
        ...
        public class FixtureData : object, Xunit.IAsyncLifetime
        {
            ...
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.InitializeAsync()
            {
                await ApiScopeFeature.FeatureSetupAsync();
            }
            
            async System.Threading.Tasks.Task Xunit.IAsyncLifetime.DisposeAsync()
            {
                await ApiScopeFeature.FeatureTearDownAsync();
            }
        }
    }
}
